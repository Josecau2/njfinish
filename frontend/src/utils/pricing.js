 ...
 */
export function applyMultiplierToItems(items, manufacturerMultiplier = 1, userGroupMultiplier = 1, applyShowroom = true) {
...
export function computeSummary({
  ...
  const customItemsTotal = customItems.reduce((sum, ci) => sum + Number(ci.price || 0) * m * showroomM, 0);
