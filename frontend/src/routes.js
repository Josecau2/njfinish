...
const ManufacturersList = React.lazy(
  () => import('./pages/settings/manufacturers/ManufacturersList'),
)
const ManufacturersForm = React.lazy(
  () => import('./pages/settings/manufacturers/ManufacturersForm'),
)
const EditManufacturer = React.lazy(() => import('./pages/settings/manufacturers/EditManufacturer'))
const ManufacturersMultipliers = React.lazy(
  () => import('./pages/settings/multipliers/ManuMultipliers'),
)
...
const CustomizationPage = React.lazy(
  () => import('./pages/settings/customization/CustomizationPage'),
)
const PdfLayoutCustomization = React.lazy(
  () => import('./pages/settings/customization/PdfLayoutCustomization'),
)
const LoginCustomizerPage = React.lazy(
  () => import('./pages/settings/customization/LoginCustomizerPage'),
)
...
const routes = [
  ...
  // Plain path -> redirect to canonical noisy path
  {
    ...
    name: 'Edit Customer (redirect)',
    element: RedirectToNoisyEditCustomer,
    permission: 'customers:update',
  },
  {
    path: '/:noise1/:noise2/customers/edit/:id',
    name: 'Edit Customer (noisy)',
  ...
  {
    path: '/quotes/edit/:id',
    name: 'EditQuote (redirect)',
    element: RedirectToNoisyEditProposal,
    permission: 'proposals:update',
  },
  {
    path: '/:noise1/:noise2/quotes/edit/:id',
    name: 'EditQuote (noisy)',
  ...
  // Settings routes (admin only)
  {
    ...
    permission: 'settings:manufacturers',
  },
  {
    path: '/settings/manufacturers/create',
    name: 'ManufacturersList',
    element: ManufacturersForm,
    permission: 'settings:manufacturers',
  },
  {
    path: '/settings/manufacturers/edit/:id',
    name: 'EditManufacturer (redirect)',
    element: RedirectToNoisyEditManufacturer,
    permission: 'settings:manufacturers',
  },
  {
    path: '/:noise1/:noise2/settings/manufacturers/edit/:id',
    name: 'EditManufacturer (noisy)',
    element: EditManufacturer,
    permission: 'settings:manufacturers',
  },
  {
    path: '/settings/usergroup/multipliers',
    name: 'ManufacturersMultipliers',
    element: ManufacturersMultipliers,
    permission: 'settings:manufacturers',
  },
  ...
  },
  {
    ...
    name: 'Users (redirect)',
    element: RedirectToNoisyEditUser,
    permission: 'settings:users',
  },
  {
    path: '/:noise1/:noise2/settings/users/edit/:id',
    name: 'Users (noisy)',
    element: EditUser,
    permission: 'settings:users',
  },
  ...
  {
    path: '/settings/users/group/create',
    name: 'Users Group',
    element: CreateUserGroup,
    permission: 'settings:groups',
  },
  {
    path: '/settings/users/group/edit/:id',
    name: 'Edit User Group (redirect)',
    element: RedirectToNoisyEditUserGroup,
    permission: 'settings:groups',
  },
  {
    path: '/:noise1/:noise2/settings/users/group/edit/:id',
    name: 'Edit User Group (noisy)',
  ...
  },
  {
    ...
    element: RedirectToNoisyEditLocation,
    permission: 'settings:locations',
  },
  {
    path: '/:noise1/:noise2/settings/locations/edit/:id',
    name: 'Locations (noisy)',
...

  {
    ...
    permission: 'settings:customization',
  },
  {
    path: '/settings/pdflayoutcustomization',
    name: 'PdfLayoutCustomization',
    element: PdfLayoutCustomization,
    permission: 'settings:customization',
  },
  {
    path: '/settings/loginlayoutcustomization',
    name: 'loginlayoutcustomization',
    element: LoginCustomizerPage,
    permission: 'settings:customization',
  },
  {
  ...
  {
    path: '/admin/contractors/:groupId',
    name: 'Contractor Detail (redirect)',
    element: RedirectToNoisyContractorDetail,
    adminOnly: true,
  },
  {
    path: '/:noise1/:noise2/admin/contractors/:groupId',
    name: 'Contractor Detail (noisy)',
  ...
  {
    path: '/quotes/:proposalId/admin-view',
    name: 'Admin Quote View (redirect)',
    element: RedirectToNoisyAdminProposalView,
    permission: 'admin:proposals_view',
  },
  {
    path: '/:noise1/:noise2/quotes/:proposalId/admin-view',
    name: 'Admin Quote View (noisy)',
