  ...
  `}</style>
      ...
      <>
        ...
        {selectedItems.length > 0 && (
          <Flex flexDir={{ base: "column", sm: "row" }} justify="space-between" align={{ base: "start", sm: "center" }} mb={3} p={3} bg={bgGray50} borderRadius="md" gap={2}>
            <Text>
              ...
              {currentItems.map((item, index) => (
                <StandardCard key={index} p={3}>
                  ...
                  <HStack justify="space-between" align="start" mb={2}>
                    <HStack align="start" spacing={2}>
                      ...
                      <VStack align="start" spacing={0}>
                        ...
                        <Text fontSize="sm" color={borderGray600}>{item.description}</Text>
                      </VStack>
                    </HStack>
                    <Badge
                      colorScheme="gray"
                  ...
                  <HStack spacing={4} mb={3}>
                    <VStack align="start" spacing={0}>
                      <Text fontSize="xs" color={iconGray500}>Price</Text>
                      <Text>${item.price}</Text>
                    </VStack>
                    <VStack align="start" spacing={0}>
                      <Text fontSize="xs" color={iconGray500}>Type</Text>
        ...
        <ModalContent borderRadius="12px">
          ...
          <ModalBody position="relative">
            ...
            {assemblyData.applyTo === 'one' &&
              ...
              assemblyCostsByType[selectedCatalogItem.type]?.assemblyCosts?.length > 0 && (
                <Box mt={3} p={3} bg={bgGray50} borderRadius="md">
                  <Text fontSize="sm" fontWeight="bold" color={borderGray600}>
            ...
            {assemblyData.applyTo === 'all' && Object.keys(assemblyCostsByType).length > 0 && (
              <Box mt={3} p={3} bg={bgGray50} borderRadius="md">
                <Text fontSize="sm" fontWeight="bold" color={borderGray600}>Existing Assembly Costs by Type:</Text>
                <Box>
            ...
            {assemblyData.applyTo === 'types' && (
              <>
                ...
                {assemblyData.selectedTypes.length > 0 && (
                  <Box mt={3} p={3} bg={bgBlue50} borderRadius="md">
                    <Text fontSize="sm">
                      {t(
              ...
              <Box>
                ...
                {modificationStep === 2 && (
                  <Box>
                    ...
                    <Box border="1px solid" borderColor={iconGray300} borderRadius="md" p={4} mb={4}>
                      <Heading as="h6" size="sm" mb={3}>Required Fields</Heading>
                    ...
                    <Box border="1px solid" borderColor={iconGray300} borderRadius="md" p={3} mb={3}>
                      ...
                      <Grid templateColumns={{ base: "1fr", md: "repeat(3, 1fr)" }} gap={3} mb={4}>
                        <GridItem>
                          <Box p={3} bg={bgGray50} borderRadius="md" border="1px solid" borderColor={iconGray300}>
                            <Checkbox
                              ...
                              <VStack spacing={3} align="stretch">
                                <Input
                                  ...
                                  onChange={(event) =>
                                    setGuidedBuilder((g) => ({
                                      ...g,
                                      qtyRange: { ...g.qtyRange, min: event.target.value },
                                    }))
                                  }
                                />
                                <Input
                                  ...
                                  onChange={(event) =>
                                    setGuidedBuilder((g) => ({
                                      ...g,
                                      qtyRange: { ...g.qtyRange, max: event.target.value },
                                    }))
                                  }
                                />
                              </VStack>
                      ...
                      <Box p={3} bg={bgGray50} borderRadius="md" border="1px solid" borderColor={iconGray300} mb={4}>
                    ...
                    <Flex mt={6} gap={3} direction={{ base: "column", md: "row" }} justify="flex-end">
