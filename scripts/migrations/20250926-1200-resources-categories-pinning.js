...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    // Resource Links extensions
    const resourceLinks = await queryInterface.describeTable('resource_links').catch(() => ({}));
    ...
    // Resource Files extensions
    const resourceFiles = await queryInterface.describeTable('resource_files').catch(() => ({}));
